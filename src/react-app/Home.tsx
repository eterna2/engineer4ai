...
const NAVIGATION: Navigation = [
  { segment: "engineer4ai", title: "Engineer4ai" },
  {
    segment: "engineer4ai/home",
    title: "Home",
    icon: <DashboardIcon />,
  },
];
...
export default function Home(props: any) {
  ...
  const { window } = props;
  const router = useDemoRouter("/engineer4ai/home");
  const onChatResponse = (response: ChatMessage) => {
      ...
      <Paper sx={{ p: 2, width: "100%" }}>
        ...
        >
          <Grid container spacing={1}>
            ...
            <Grid size={8}>
              <Chat onResponse={onChatResponse} />
            </Grid>
          </Grid>
        </PageContainer>
      </Paper>
